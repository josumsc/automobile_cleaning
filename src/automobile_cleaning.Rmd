...
lm_asia <- lm (formula = price.range ~ symboling +
                 ...
                 peak.rpm + city.mpg + highway.mpg, data = dataset_by_continent[['asia']])

lm_america <- lm (formula = price.range ~ symboling + 
                    normalized.losses + wheel.base + length + 
                    width + height + curb.weight + engine.size +
                    bore + stroke + compression.ratio + horsepower + 
                    peak.rpm + city.mpg + highway.mpg, data = dataset_by_continent[['america']])

lm_europe <- lm (formula = price.range ~ symboling + 
                   normalized.losses + wheel.base + length + 
                   width + height + curb.weight + engine.size + 
                   bore + stroke + compression.ratio + horsepower +
                   peak.rpm + city.mpg + highway.mpg, data = dataset_by_continent[['europe']])
...
glm_general <- glm (formula = price.range ~ symboling + 
                    ...
                    width + height + curb.weight + engine.size + 
                    bore + stroke + compression.ratio + horsepower +
                    peak.rpm + city.mpg + highway.mpg, data = dataset, family=binomial)
```
